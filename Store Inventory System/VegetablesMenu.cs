...
namespace Store_Inventory_System
{
    ...
    {
        private List<Vegetables> Vegetableses;
        ...
        public void AddVegetables()
        {
            ...
            double vegetablePrice = Convert.ToDouble(vegetablePR);
        ...
        {
            int sum = 0;
            foreach (var vegetable in Vegetableses)
            {
            ...
            foreach (var vegetable in Vegetableses)
            {
                Console.WriteLine($"{vegetable.Name} - {vegetable.Quantity}kg");
            }
        }
    }
}
